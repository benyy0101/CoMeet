...
public class QKeyword extends EntityPathBase<Keyword> {
    ...
    private static final long serialVersionUID = -1436087036L;
    ...
    public final ListPath<RoomKeyword, QRoomKeyword> roomKeywords = this.<RoomKeyword, QRoomKeyword>createList("roomKeywords", RoomKeyword.class, QRoomKeyword.class, PathInits.DIRECT2);
