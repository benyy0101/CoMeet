...
| 팀장, PM, 로그인, 방 목록,                                                                                 | 캠/화면 공유(프론트), 코드 동시 편집, 메인페이지                                                                              | UX/UI, 게시판/글 페이지, 댓글, 유저페이지, TIL/워드클라우드/메타데이터, 이미지 업로드                                                                                                                     | 캠/화면 공유(백)<br/> 방 동시성 구현, 채팅, 게시판 CRUD 구현                                                                                  | 인증/인가<br/> 방 CRUD<br/> 메타데이터 로직                                                                        | 인프라 구축, CI/CD                                                                                 |
